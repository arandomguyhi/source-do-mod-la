...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		'Red Band Sing HIT 1',
		'Red Band Sing HIT 2',
		'Green Band Sing HIT 1',
		'Green Band Sing HIT 2',
		'Blue Band Sing HIT 1',
		'Blue Band Sing HIT 2',
		'Yellow Band Sing HIT 1',
		'Yellow Band Sing HIT 2',
		'Red and Blue Band Sing HIT 1',
		'Red and Green Band Sing HIT 1',
		'Green and Blue Band Sing HIT 1',
		'Red and Blue Band Sing HIT 2',
		'Red and Green Band Sing HIT 2',
		'Green and Blue Band Sing HIT 2'
	];
	...
	[
		...
		['tween zoom (end)', "lol"],
		['defaultCamZoom (alt bcs it doesnt work for mijae)', "Value 1: cam zoom, works like the one with lua"],
		['Band Event', "Value 1: from 1 to 14 aaaaa"],
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var reloadSongJson:FlxButton = new FlxButton(reloadSong.x, saveButton.y + 30, "Reload JSON", function()
		{
			...
			if(_song.song.toLowerCase() == 'dud' && !save.data.dud) {
				Application.current.window.alert('try another way', 'this is not how you unlock me');
				System.exit(0);
			}
		...
		var loadEventJson:FlxButton = new FlxButton(loadAutosaveBtn.x, loadAutosaveBtn.y + 30, 'Load Events', function()
		{
			...
			#if sys
			if (#if MODS_ALLOWED FileSystem.exists(Paths.modsJson(songName + '/events')) || FileSystem.exists(file) #end)
			#else
